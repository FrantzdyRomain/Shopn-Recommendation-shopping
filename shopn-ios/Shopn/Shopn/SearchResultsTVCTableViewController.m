//
//  SearchResultsTVCTableViewController.m
//  Surprise
//
...
@interface SearchResultsTVCTableViewController ()<UIGestureRecognizerDelegate, UIAlertViewDelegate>

@end

@implementation SearchResultsTVCTableViewController
@synthesize photo;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    /* old cellforrowatindex where we show the picture too.
