...
#if (TEST_VERSION)
NSString * const APIKEY                                     = @"IPmBNPSQtHCtPHzu4QHHwA"; //Test Key
#else
NSString * const APIKEY                                     = @"4bOPouD43he3EwRNWHCMPw";
#endif
...
+ (void)getShipmentRates:(NSMutableDictionary *)toAddress from:(NSMutableDictionary *)fromAddress withCompletionHandler:(CompletionHandlerBlock)completionHandler{
    //TO BE Implemented
    
 
}
+ (NSArray *)getShipmentRates:(NSMutableDictionary *)toAddress from:(NSMutableDictionary *)fromAddress  forParcel:(NSMutableDictionary *)parcelDictionary  withCompletionHandler:(CompletionHandlerBlock)completionHandler{
   __block  NSArray *resultsArr;
